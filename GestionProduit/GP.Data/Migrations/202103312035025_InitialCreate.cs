namespace GP.Data.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Categorie_CategoryId = c.Int(),
                    })
                .PrimaryKey(t => t.ProductId)
                .ForeignKey("dbo.Categories", t => t.Categorie_CategoryId)
                .Index(t => t.Categorie_CategoryId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Products", "Categorie_CategoryId", "dbo.Categories");
